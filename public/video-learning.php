...
<head>
    ...
    <title>วิดีโอการเรียนการสอน - KNA Interpharma</title>
            ...
            <div class="flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
                <div class="max-w-2xl">
                    ...
                    <p class="mt-5 text-base leading-8 text-slate-300">
                        องค์ความรู้ทางวิชาการและข้อมูลผลิตภัณฑ์เชิงลึก จัดทำโดย KNA Interpharma เฉพาะบุคลากรทางการแพทย์ที่ผ่านการยืนยันแล้ว
                    </p>
                </div>
